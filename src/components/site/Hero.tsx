  ...
  return (
    <section id="home" ref={ref} className="relative h-[100svh] min-h-[640px] w-full overflow-hidden bg-rr-black">
      ...
      <motion.div
        ...
        className="absolute inset-0 bg-linear-to-t from-[#080808] via-[#080808]/60 to-[#080808]/20"
      />
      ...
      >
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a
              href="#booking"
              className="inline-flex items-center gap-2 border-2 border-rr-red bg-rr-red px-7 py-3.5 text-sm font-semibold text-white shadow-[5px_5px_0_rgba(255,255,255,0.15)] transition-all duration-150 hover:translate-x-1 hover:translate-y-1 hover:shadow-none"
            >
