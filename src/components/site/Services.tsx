...
const CATS: Category[] = [
  {
    ...
    image: "https://res.cloudinary.com/ddn6tl045/image/upload/v1779615591/hair_hxyk9j.png",
    items: ["Stylish Haircut", "Hair Coloring", "Hair Spa", "Hair Treatments"],
  },
  {
    title: "Skin", subtitle: "Care",
    image: "https://res.cloudinary.com/ddn6tl045/image/upload/v1779615591/skin_fxkvbs.png",
    items: ["Facial", "Cleanup", "Detan", "Skin Brightening"],
  },
  {
    title: "Beauty", subtitle: "Services",
    image: "https://res.cloudinary.com/ddn6tl045/image/upload/v1779615590/beauty_kqmdso.png",
    items: ["Waxing", "Threading", "Pedicure", "Manicure"],
  },
  {
    title: "Bridal", subtitle: "Packages",
    image: "https://res.cloudinary.com/ddn6tl045/image/upload/v1779615590/bride_el4bfp.png",
    ...
    <motion.div className="absolute inset-0 overflow-hidden" style={{ y, scale, zIndex: index + 1, transformOrigin: "50% 0" }}>
      ...
      <div className="hidden h-full lg:flex">
        <div className="relative flex w-[42%] shrink-0 flex-col justify-center bg-rr-cream px-14 xl:px-20">
          <div className="relative z-10">
            ...
            <a
              href="/#booking"
              className="mt-10 inline-flex items-center gap-2 rounded-full bg-rr-red px-7 py-3.5 text-sm font-semibold text-white shadow-md transition-all duration-200 hover:shadow-lg hover:brightness-110"
            >
      ...
      <div className="relative flex h-full flex-col justify-end lg:hidden">
        ...
        <div className="relative z-10 px-6 pb-24 pt-8">
          ...
          <a href="/#booking" className="mt-7 inline-flex items-center gap-2 rounded-full bg-rr-red px-6 py-3 text-sm font-semibold text-white shadow-md transition-all duration-200 hover:shadow-lg hover:brightness-110">
