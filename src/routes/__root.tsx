...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://res.cloudinary.com/ddn6tl045/image/upload/v1779615591/og-image_kbehbf.jpg" },
      ...
      { name: "twitter:image", content: "https://res.cloudinary.com/ddn6tl045/image/upload/v1779615591/og-image_kbehbf.jpg" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", href: "https://res.cloudinary.com/ddn6tl045/image/upload/v1779615590/logo_uuvi8k.png", type: "image/png" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "image": "https://res.cloudinary.com/ddn6tl045/image/upload/v1779615590/logo_uuvi8k.png",
